    ...
    with col:
        ...
        <div style='background:#071233; border:1px solid #1A3A6E;
            ...
            <p style='color:#00CFFF; font-family:IBM Plex Mono; font-size:0.75rem;
                      letter-spacing:3px; margin:0 0 16px 0; text-align:center;'>AUDIT DESK · ITC RECON</p>
            <p style='color:#FFFFFF; font-size:1.3rem; font-weight:700;
                      margin:0 0 24px 0; text-align:center;'>Sign In</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        if submit:
            if not email_input or not pass_input:
                ...
                _do_login(email_input.strip().lower(), pass_input)

        if forgot:
            if not email_input:
                st.error("Please enter your email address above first.")
            else:
                _send_password_reset(email_input.strip().lower())

        st.markdown("""
        <div style='text-align:center; margin-top:20px;'>
            <p style='color:#8899BB; font-size:0.8rem; margin:0 0 8px 0;'>
            New user? Register at our website</p>
            <a href='https://itcrecon.in' style='color:#00CFFF; font-size:0.85rem;
