...
[data-testid="stFileUploader"] section > button {
    background: #071233 !important; color: #00CFFF !important;
...
[data-testid="stFileUploaderDropzoneInstructions"] small {
    color: #FFFFFF !important; opacity: .85 !important;
}
[data-testid="stFileUploader"] label,
[data-testid="stFileUploader"] > label,
[data-testid="stFileUploader"] > div > label,
[data-testid="stWidgetLabel"] span,
.stFileUploader label { color: #FFFFFF !important; opacity: 1 !important; }
/* ── Download button ───────────────────────────────────────── */
[data-testid="stDownloadButton"] > button {
    background: linear-gradient(135deg, #0095BF, #00CFFF) !important;
    color: #0A1B44 !important; border: none !important;
    ...
    with st.sidebar:
        ...
        with st.expander("💬 Feedback / Ideas / Issues"):
            ...
            suggestion = st.text_area(
                "Your message",
                placeholder="e.g. I'd love a GSTR-9 reconciliation feature...",
            ...
            with tab4:
                ...
                if si_df is not None and not si_df.empty:
                    ...
                    st.markdown(
                        ...
                        "&#9679; Filing Rate = % of this supplier's invoices in your GSTR-2B.<br>"
                        "&#9679; Repeat Defaulter = filed under 50% of their own invoices "
