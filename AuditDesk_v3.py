            ...
            <div style='background:#071233; border:1px solid #00CFFF;
                ...
                <div style='display:grid; grid-template-columns:1fr 1fr; gap:10px;'>
                    <div>
                        ...
                        <p style='color:#FFD700; font-size:1.2rem; font-weight:700; margin:2px 0 10px 0;'>₹{taxable:,.2f}</p>
                    </div>
                    <div>
                        <p style='color:#FFFFFF; font-size:0.75rem; margin:0;'>{lbl_gst}</p>
                        <p style='color:#FFD700; font-size:1.2rem; font-weight:700; margin:2px 0 10px 0;'>₹{gst_amt:,.2f}</p>
                    </div>
                    {"" if is_igst else f'''
                    <div>
                        <p style='color:#FFFFFF; font-size:0.75rem; margin:0;'>CGST @{rate//2}%</p>
                        <p style='color:#00CFFF; font-size:1.1rem; font-weight:700; margin:2px 0 10px 0;'>₹{cgst:,.2f}</p>
                    </div>
                    <div>
                        <p style='color:#FFFFFF; font-size:0.75rem; margin:0;'>SGST @{rate//2}%</p>
                        <p style='color:#00CFFF; font-size:1.1rem; font-weight:700; margin:2px 0 10px 0;'>₹{sgst:,.2f}</p>
                    </div>'''}
                    {f'''<div style='grid-column:span 2;'>
                        <p style='color:#FFFFFF; font-size:0.75rem; margin:0;'>IGST @{rate}%</p>
                        <p style='color:#00CFFF; font-size:1.1rem; font-weight:700; margin:2px 0 10px 0;'>₹{igst:,.2f}</p>
                    </div>''' if is_igst else ""}
                </div>
                <hr style='border-color:#1A3A6E; margin:10px 0;'>
                <p style='color:#FFFFFF; font-size:0.75rem; margin:0;'>Total Invoice Value</p>
                <p style='color:#00CFFF; font-size:1.5rem; font-weight:700; margin:4px 0 0 0;'>₹{total:,.2f}</p>
            </div>
            """, unsafe_allow_html=True)
...
{"CGST          : ₹" + f"{cgst:,.2f}" + chr(10) + "SGST          : ₹" + f"{sgst:,.2f}" if not is_igst else "IGST          : ₹" + f"{igst:,.2f}"}
